...
<html lang="pt-br">
	...
	<body>
		<form action="inserir.php" method="POST"  class = "cadastro">
			...
			<br/>
			<label>RG:</label>
			<input type="number" name="RG" required  min="11111111" max="9999999999"/>
			<br/>
			<label>PIS:</label>
			<input type="number" name="Pis" required  min="11111111111" max="99999999999"/>
			<br/>
			<label>Senha:</label>
			<input type="text" name="Senha" required min="1111111111" max="9999999999" />
			<br/>
			<label>DDD:</label>
