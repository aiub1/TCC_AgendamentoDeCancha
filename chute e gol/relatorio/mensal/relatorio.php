...
<html>
	...
	<body>
		<?php			
			...
			$pdf->Cell(0,5,"RELATÓRIO MENSAL DO MÊS $hoje DE $ano",0,1,'C');
			$pdf->Cell(0,5,"","B",1,'C');
			$pdf->Ln(50);
			...
			$sql = "SELECT 
				...
				WHERE aluguel.CodCancha=cancha.CodCancha AND aluguel.CodCliente=cliente.CodCliente AND aluguel.CodFunc=funcionario.CodFunc AND month(aluguel.Data_Age) = '$hoje'";
			...
			if ($result->num_rows > 0)
		{
			...
			$pdf->SetFont('arial','',12);
				...
				$pdf->Cell(130,20,'Nome Funcionario',1,0,"L");
				$pdf->Cell(173,20,'Data Age',1,1,"L");
				
						
			//linhas da segunda tabela
			$pdf->SetFont('arial','',12);
			    $pdf->Cell(255,20,$linha["CodCliente"],1,0,"L");
			    $pdf->Cell(130,20,$linha["NomeFunc"],1,0,"L");
				$pdf->Cell(173,20,$linha["Data_Age"],1,1,"L");
				$pdf->Ln(50);
